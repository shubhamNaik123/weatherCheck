...
-(void) UIDataDisplay: (NSString *)latitude longitude:(NSString *)longitude location:(NSString *)location connected: (BOOL) connected
{
    ...
    self.imgIcon_url.image = [UIImage imageNamed: [self displayIcon:[day0 valueForKey:@"icon"]]];
